#!/bin/bash
# ============================================================
# SLURM job: Full model (physics) with different split seed (fold 2)
# ============================================================
#SBATCH --job-name=mamba-s2-full
...
#SBATCH --output=logs/train_seed2_full_%j.out
#SBATCH --error=logs/train_seed2_full_%j.err
#SBATCH --mail-type=END,FAIL

# --- Setup ---
echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [SEED 456 / FULL MODEL]"
...
# --- Training ---
echo ""
echo "Starting training (seed 456, full model) with 4 GPUs..."
echo ""
