#!/bin/bash
# ============================================================
# SLURM job: Full model with 70/15/15 split (fewer training solutions)
# ============================================================
#SBATCH --job-name=mamba-70-15
...
#SBATCH --output=logs/train_70_15_%j.out
#SBATCH --error=logs/train_70_15_%j.err
#SBATCH --mail-type=END,FAIL

# --- Setup ---
echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [70/15/15 SPLIT]"
...
# --- Training ---
echo ""
echo "Starting training (70/15/15 split) with $(python -c 'import torch; print(torch.cuda.device_count())') GPUs..."
echo ""
