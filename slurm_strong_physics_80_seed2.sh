#!/bin/bash
# ============================================================
# SLURM job: Strong physics (5x lambdas) at 80/10/10, seed 456
# ============================================================
#SBATCH --job-name=strong-s2
...
#SBATCH --output=logs/strong_80_seed2_%j.out
#SBATCH --error=logs/strong_80_seed2_%j.err
#SBATCH --mail-type=END,FAIL

echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [STRONG PHYSICS 80/10/10 SEED 456]"
