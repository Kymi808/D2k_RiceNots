#!/bin/bash
# ============================================================
# SLURM job: Strong physics (5x lambdas) at 40/30/30
# ============================================================
#SBATCH --job-name=strong-40
...
#SBATCH --output=logs/strong_40_%j.out
#SBATCH --error=logs/strong_40_%j.err
#SBATCH --mail-type=END,FAIL

echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [STRONG PHYSICS 40/30/30]"
