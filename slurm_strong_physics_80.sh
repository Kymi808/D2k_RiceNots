#!/bin/bash
# ============================================================
# SLURM job: Strong physics (5x lambdas) at 80/10/10
# ============================================================
#SBATCH --job-name=strong-80
...
#SBATCH --output=logs/strong_80_%j.out
#SBATCH --error=logs/strong_80_%j.err
#SBATCH --mail-type=END,FAIL

echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [STRONG PHYSICS 80/10/10]"
