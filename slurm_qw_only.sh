#!/bin/bash
# ============================================================
# SLURM job: Mamba CFD — QW ONLY (single-output ablation)
# ============================================================
#SBATCH --job-name=mamba-qwonly
...
echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [QW ONLY]"
...
echo ""
echo "Starting training (QW ONLY) with $(python -c 'import torch; print(torch.cuda.device_count())') GPUs..."
echo ""
