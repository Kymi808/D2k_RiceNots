#!/bin/bash
# ============================================================
# SLURM job: Deep heads + residual FFN with 60/20/20 split
# ============================================================
#SBATCH --job-name=dhffn-60-20
...
#SBATCH --output=logs/deep_head_ffn_60_20_%j.out
#SBATCH --error=logs/deep_head_ffn_60_20_%j.err
#SBATCH --mail-type=END,FAIL

echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [DEEP HEAD + FFN 60/20/20]"
...
echo ""
echo "Starting deep-head + residual-FFN training (60/20/20 split) with 4 GPUs..."
echo ""
