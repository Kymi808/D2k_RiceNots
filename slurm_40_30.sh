#!/bin/bash
# ============================================================
# SLURM job: Full model with 40/30/30 split
# ============================================================
#SBATCH --job-name=mamba-40-30
...
#SBATCH --output=logs/train_40_30_%j.out
#SBATCH --error=logs/train_40_30_%j.err
#SBATCH --mail-type=END,FAIL

# --- Setup ---
echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [40/30/30 SPLIT]"
...
# --- Training ---
echo ""
echo "Starting training (40/30/30 split) with 4 GPUs..."
echo ""
