#!/bin/bash
# ============================================================
# SLURM job: Full model with 60/20/20 split (fewer training solutions)
# ============================================================
#SBATCH --job-name=mamba-60-20
...
#SBATCH --output=logs/train_60_20_%j.out
#SBATCH --error=logs/train_60_20_%j.err
#SBATCH --mail-type=END,FAIL

# --- Setup ---
echo "============================================"
echo "Job ID: $SLURM_JOB_ID  [60/20/20 SPLIT]"
...
# --- Training ---
echo ""
echo "Starting training (60/20/20 split) with $(python -c 'import torch; print(torch.cuda.device_count())') GPUs..."
echo ""
